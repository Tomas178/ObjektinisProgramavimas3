...
class Studentas : public Zmogus {
    ...
    public:
        ...
        /**
         * @brief Priskirti medianos balą.
         * @param med medianos balas.
         */
        void SetMediana(double med) { this->mediana = med; }

        /**
         * @brief Priskirti vidurkio balą.
         * @param vid vidurkio balas.
         */
...
extern ManoVector<string> Vardai; /**< Vardų vektorius skirtas generuoti atsitiktinius vardus*/
extern ManoVector<string> Pavardes; /**< Pavardžių vektorius skirtas generuoti atsitiktines pavardes*/
extern ManoVector<Studentas> Lievi; /**< Studentų vektorius, kurie gavo skolą*/
extern ManoVector<Studentas> Studentai; /**< Studentų vektorius, kurie išlaikė dalyką*/
